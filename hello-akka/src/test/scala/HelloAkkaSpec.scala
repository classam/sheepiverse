...
class HelloAkkaSpec(_system: ActorSystem)
  ...
  "An HelloAkkaActor" should "be able to set a new greeting" in {
    ...
    greeter.underlyingActor.asInstanceOf[Greeter].greeting should be("eat my butt, testkit")
  }
  ...
  it should "be able to get a new greeting" in {
    ...
    greeter ! WhoToGreet("testkit")
    greeter ! Greet
    expectMsgType[Greeting].message.toString should be("eat my butt, testkit")
  }
  */
}
